...
export function createInjectCardTool(context) {
  return {
    name: 'inject_card',
    description: 'Deprecated compatibility alias for render_block(). Inject a pre-built React card template into a specific AIZone.',
    parameters: {
      zoneId: {
        type: 'string',
...
//# sourceMappingURL=injectCardTool.js.map