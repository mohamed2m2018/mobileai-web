  ...
  return /* @__PURE__ */ jsxs("div", { style: cardStyle(theme), children: [
    ...
    facts.length ? /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: facts.map((fact) => /* @__PURE__ */ jsxs(
          "div",
          {
            style: {
    ...
    /* @__PURE__ */ jsx(ActionButtons, { actions, sourceBlockId: "FactCard" })
  ] });
}
function ActionCardWeb({ title = "Next step", body, primaryAction, secondaryAction, chips = [] }) {
  const theme = useRichUITheme();
  ...
  return /* @__PURE__ */ jsxs("div", { style: cardStyle(theme), children: [
    ...
    /* @__PURE__ */ jsx(ActionButtons, { actions, sourceBlockId: "ActionCard" })
  ] });
}
function ComparisonCardWeb({ title = "Compare options", items = [] }) {
  const theme = useRichUITheme();
  return /* @__PURE__ */ jsxs("div", { style: cardStyle(theme), children: [
    /* @__PURE__ */ jsx(
      "div",
      ...
      "div",
      {
        ...
        children: items.map((item, index) => /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              item.imageUrl || item.image ? /* @__PURE__ */ jsx(
                "img",
                {
...
function FormCardWeb({ title = "Confirm details", body, fields = [], submitAction, cancelAction }) {
  const theme = useRichUITheme();
  const bridge = useActionBridge();
    ...
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: fields.map((field) => {
          const commonLabel = /* @__PURE__ */ jsx(
            "div",
            {
              style: {
                fontSize: theme.typography.metaSize,
...
const webBlockDefinitions = [
  {
    ...
    propSchema: {
      title: {
        type: "string",
        description: 'The EXACT product name as shown on the page (e.g. "Nimbus Smart Watch"). Required for a recommendation \u2014 never use a generic placeholder like "Recommended item".'
      },
      name: {
        type: "string",
      ...
      imageUrl: {
        type: "string",
        description: "Only a real image URL that actually appears on the current page. If you do not have a real URL, OMIT this prop \u2014 never invent, guess, or use an example URL."
      },
      image: {
        type: "string",
