...
export function createRenderBlockTool(context) {
  return {
    name: 'render_block',
    description: 'Render a registered UI block into a specific AIZone as a temporary contextual intervention. Use this only when a local in-screen block helps the user decide, fix, or proceed faster than chat.',
    parameters: {
      zoneId: {
        type: 'string',
...
//# sourceMappingURL=renderBlockTool.js.map