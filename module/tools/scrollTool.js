...
export function createScrollTool(context) {
  return {
    name: 'scroll',
    ...
    execute: async args => context.platformAdapter.executeAction({
      ...
      amount: args.amount,
      containerIndex: typeof args.containerIndex === 'number' ? args.containerIndex : undefined
    })
  };
}
//# sourceMappingURL=scrollTool.js.map