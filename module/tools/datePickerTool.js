...
export function createDatePickerTool(context) {
  return {
    name: 'set_date',
    ...
    parameters: {
      ...
      date: {
        type: 'string',
        description: 'Date in ISO 8601 format, e.g., "2025-03-25" or "2025-03-25T14:30:00"',
        required: true
      }
    },
...
//# sourceMappingURL=datePickerTool.js.map