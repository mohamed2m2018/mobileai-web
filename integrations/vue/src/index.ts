...
import type { TwomiliaConfig, TwomiliaTool } from "@twomilia/web";

// Re-export the core types so consumers import everything from one package.
 ...
 */
export const TwomiliaPlugin: Plugin<[TwomiliaConfig]> = {
  install(_app: App, config: TwomiliaConfig) {
