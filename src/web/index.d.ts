...
export type { WebRouterAdapter } from './core/WebPlatformAdapter';
export { ProductCardWeb, FactCardWeb, ActionCardWeb, ComparisonCardWeb, FormCardWeb, webBlockDefinitions, } from './blocks';
